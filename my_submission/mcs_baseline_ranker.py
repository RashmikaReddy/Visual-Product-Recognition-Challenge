...
class MCS_BaseLine_Ranker:
    def __init__(self, dataset_path, gallery_csv_path, queries_csv_path):
        ...
        # Add your code below
        #checkpoint_path = '/Users/rashmikareddyvookanti/visual-product-recognition-2023-starter-kit/MCS2023_baseline/experiments/baseline_mcs/baseline_model.pth'
        #checkpoint_path = '/Users/rashmikareddyvookanti/Downloads/baseline_model.pth'
